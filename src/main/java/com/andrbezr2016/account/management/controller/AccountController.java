...
public class AccountController {
    ...
    @PostMapping("/account")
    public ResponseEntity<String> createAccount(@AllowedSources @RequestHeader(name = "X-Source") String source, @Valid @RequestBody RequestAccountDto requestAccountDto, Errors errors) {
